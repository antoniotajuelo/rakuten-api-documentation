...
title<br>*Software Title* | string | At least one is required | Keywords to search from the software title.<br>This string needs to be UTF-8 encoded.<br>If you want to use multiple keywords in your search, please separate them using spaces.<br>**Valid Values:**
os<br>*Supported OS* | string | At least one is required | Search for supported OS (operating system).<br>This string needs to be UTF-8 encoded.<br>**Valid Values:**
...
jan<br>*Software JAN code* | long | At least one is required | Search for a software JAN code.<br>**Valid Values:**
