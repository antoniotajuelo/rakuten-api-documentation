...
title<br>*Title* | string | At least one is required | Search for a magazine title.<br>This parameter must be UTF-8 encoded.<br>You can search multiple keywords separating them by a space.<br>**Valid Values:**
...
jan<br>*Magazine JAN code* | long | At least one is required | Search for a magazine JAN code.<br>**Valid Values:**
