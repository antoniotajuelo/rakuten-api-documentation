...
booksGenreId<br>*Book genre ID* | string | Optional | Use it for narrow results to a specific book genre ID.<br>Please use the Book Genre Search API to look up book genre names and genre relations.<br>Please note that this genre is different from the Rakuten Ichiba genre.<br>**Default Value:** <code>001</code>
