...
title<br>*Title* | string | At least one is required | Keywords to search from the title of the CD.<br>This string needs to be UTF-8 encoded.<br>If you want to use multiple keywords in your search, please separate them using spaces.<br>**Valid Values:**
artistName<br>*Artist Name* | string | At least one is required | Keywords to search from the artist's or composer's name.<br>This string needs to be UTF-8 encoded.<br>If you want to use multiple keywords in your search, please separate them using spaces.<br>**Valid Values:**
...
jan<br>*CD JAN code* | long | At least one is required | Search for a JAN code associated to a CD.<br>**Valid Values:**
