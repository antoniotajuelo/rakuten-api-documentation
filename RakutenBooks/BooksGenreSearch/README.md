...
Name | Type | Required | Description
 --- | --- | --- | --- 
booksGenreId<br>*Book genre ID* | string | Required | Genre ID to get information from.<br>Root booksGenreId is <code>000</code>.<br>**Valid Values:**
...
genrePath<br>*Genre path* | integer | Optional | Whether to include ancestor genres or not in the response.<br>0: do not include ancestors<br>1: include ancestors<br>**Valid Values:**<br>**Default Value:** <code>0</code>
