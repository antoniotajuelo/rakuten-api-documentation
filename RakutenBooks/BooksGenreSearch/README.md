...
genrePath<br>*Genre path* | integer | Optional | Whether to include ancestor genres or not in the response.<br>0: do not include ancestors<br>1: include ancestors<br>**Default Value:** <code>0</code>
