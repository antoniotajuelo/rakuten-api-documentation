...
Name | Type | Required | Description
 --- | --- | --- | --- 
golfCourseId<br>*Golf course ID* | long | Required | You can get this value from the output of Rakuten GORA golf Search API (GoraGolfCourceSearch)<br>**Valid Values:**
...
carrier<br>*Platform* | integer | Optional | Whether to request information for PC or mobile phone usage:<br>**Valid Values:**<br><code>0</code> PC<br><code>1</code> Mobile<br>**Default Value:** <code>0</code>
