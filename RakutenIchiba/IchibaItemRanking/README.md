...
page<br>*Page number* | integer | Optional | An integer between 1 and 34<br>*It is possible to specify rankings below 30th place.<br>**Default Value:** <code>1</code>
period<br>*Period for ranking* | string | Optional | realtime: retrieve data in real time<br>**Default Value:** <code>realtime</code>
