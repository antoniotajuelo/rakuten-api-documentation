...
genreId<br>*Genre ID* | string | At least one is required | ID to specify a genre in Rakuten Ichiba.<br>**Valid Values:**
productId<br>*Product ID* | string | At least one is required | ID of the product.<br>**Valid Values:**
...
maxPrice<br>*Maximum price* | long | Optional | An integer greater than 0 and less than 999,999,999<br>maxPrice must be larger than minPrice.<br>**Valid Values:**
